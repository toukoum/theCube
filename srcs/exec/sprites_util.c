...
/*   Updated: 2024/05/25 13:06:47 by rgiraud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	cub->sprites[0].sprite_pos.x = 1.5;
	cub->sprites[0].sprite_pos.y = 1.5;
	cub->sprites[0].idx_textures = 0;
	cub->sprites[1].sprite_pos.x = 4.5;
	cub->sprites[1].sprite_pos.y = 2.5;
...
void	calculate_pos_relative_sprite(int i, t_cub *cub)
{
	...
	sprite.x = cub->sprites[isprite].sprite_pos.x - cub->player.x;
	sprite.y = cub->sprites[isprite].sprite_pos.y - cub->player.y;
